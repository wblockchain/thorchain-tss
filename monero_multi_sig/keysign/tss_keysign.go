...
func NewMoneroKeySign(localP2PID string,
	...
	stopChan chan struct{}, msgID string, privKey tcrypto.PrivKey, p2pComm *p2p.Communication, rpcAddress, poolAddress string) (*MoneroKeySign, moneroWallet.Client, error) {
