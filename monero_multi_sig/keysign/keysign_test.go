...
//
//func observeAndStop(c *C, tssKeySign *MoneroKeySign, stopChan chan struct{}) {
//	for {
//		select {
//		case <-stopChan:
//			return
...
//}
//
//func rejectSendToOnePeer(c *C, tssKeySign *MoneroKeySign, stopChan chan struct{}, targetPeers []peer.ID) {
//	for {
//		select {
//		case <-stopChan:
//			return
